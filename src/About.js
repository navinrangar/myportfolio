...
<a name="aboutsection"> </a>
            <div>
            <h2 className="font-bold text-3xl pl-5 sm:pl-0 sm:text-center m-6 underline"> About Navin </h2>

            <div className="flex indent-2 text-yellow-700 sm:space-x-4 ml-1 sm:ml-4 pb-16">
