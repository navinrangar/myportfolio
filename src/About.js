...
function About(props) {
    return(
        <div className="p-1 pt-2 text-ellipsis sm:p-24 pb-4  bg-gray-200 text-xl ">
<a name="aboutsection"> </a>
            <div>
            <h2 className="font-bold text-3xl pl-9 sm:pl-0 sm:text-center m-6 underline"> About Navin </h2>

            <div className="flex text-center text-yellow-700 sm:space-x-4 ml-1 mr-1 sm:ml-4 pb-16">
